...
function getRelevantRoute(route, req) {
    let ret = {
        path: {},
        query: {},
        body: {},
...
function createRouteHandlers(module, middleware, route, app) {
    ...
    ["get", "put", "post", "patch", "del", "options"].forEach((method) => {
        if (module[method] && typeof module[method] === "function") {
            ...
            app.app[method === "del" ? "delete" : method](route, [...middleware, ...methodMiddleware], wrapHandler(module[method], route));
